...
const Header = () => {
  ...
  return (
    <header className="sticky top-0 z-50 max-w-5xl mx-auto border-border/40 bg-background/95 backdrop-blur supports-[backdrop-filter]:bg-background/60">
      <div className="flex h-14 items-center justify-end mx-3 md:mx-8">
        <nav className="flex items-center gap-4 text-sm lg:gap-6 text-foreground/60">
          ...
          <Link
            href="https://github.com/muhammad-zulfikar/jobLog"
            target="blank"
